...
function DashboardPortfolioPanel() {
  return (
    <aside className="space-y-4">
      <h2 className="text-2xl font-bold text-[var(--color-ink)]">Active Portfolio</h2>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-slate-900 text-white shadow-sm">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <p className="mb-2 inline-block rounded-full bg-[var(--color-primary)] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em]">
            Featured Estate
          </p>
      ...
      <div className="rounded-3xl border border-slate-200 bg-[#dde5ee] p-4">
        <div className="flex items-center gap-3">
          <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[rgba(0,82,204,0.12)] text-[var(--color-primary)]">
          ...
          <div>
            <p className="text-base font-semibold text-[var(--color-ink)]">Portfolio Yield</p>
            <p className="text-xs text-[var(--color-secondary)]">Annualized return profile</p>
          </div>
        </div>
        ...
        <div className="mt-3 flex items-center justify-between text-sm">
          <p className="text-[var(--color-secondary)]">Target: $1M</p>
          <p className="font-semibold text-[var(--color-primary)]">$720k (72%)</p>
        </div>
      </div>
    </aside>
  )
